...
class AudioRouter {
     ...
     * Async to allow MIDI initialization if needed
     */
    async panic() {
        ...
        // Panic on enabled outputs (await MIDI panic to allow initialization)
        if (this.midiEnabled) {
            await midiOutput.panic();
        }
