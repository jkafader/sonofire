...
class HarmonicContextService {
    ...
    setPoolAndTonic(poolKey, tonicNote, tonicName) {
        console.log(`HarmonicContext: setPoolAndTonic() called with poolKey="${poolKey}", tonicNote=${tonicNote}, tonicName="${tonicName}"`);
        ...
        // Publish to PubSub with pool/tonic format
