...
class WhipDragHandlerClass {
    ...
    initialize() {
        ...
        console.log('WhipDragHandler: Initialized');
    }

    /**
     * Start drag from a source light
     * @param {MouseEvent} event - Mouse event
     * @param {Object} sourceData - { visualizerId, playheadId, playhead, color }
     */
    startDrag(event, sourceData) {
        ...
        console.log(`WhipDragHandler: Started drag from ${sourceData.visualizerId}:${sourceData.playheadId}`);
    }
    ...
    onMouseUp(event) {
        ...
        if (targetLight) {
            ...
            console.log('WhipDragHandler: Drag cancelled (not dropped on target)');
        }
    ...
    createBinding(targetLightElement) {
        ...
        console.log(`WhipDragHandler: Created binding ${binding.id}`);
    }
    ...
    createTempLine(x, y) {
        ...
        line.setAttribute('x1', this.dragData.startX);
        line.setAttribute('y1', this.dragData.startY);
    ...
    cancel() {
        ...
        console.log('WhipDragHandler: Drag cancelled');
        this.endDrag();
    }
}
